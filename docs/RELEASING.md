...
`v0.1.9` publishes image tags `0.1.9`, `0.1`, `sha-<short-commit>`, and `latest`, then
publishes the Helm chart as OCI version `0.1.9`. Pre-release tags do not move `latest`.
...
To release `0.1.9` after CI passes:
