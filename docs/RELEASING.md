...
`v0.1.6` publishes image tags `0.1.6`, `0.1`, `sha-<short-commit>`, and `latest`, then
publishes the Helm chart as OCI version `0.1.6`. Pre-release tags do not move `latest`.
...
To release `0.1.6` after CI passes:
