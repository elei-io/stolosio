...
`v0.1.12` publishes image tags `0.1.12`, `0.1`, `sha-<short-commit>`, and `latest`, then
publishes the Helm chart as OCI version `0.1.12`. Pre-release tags do not move `latest`.
